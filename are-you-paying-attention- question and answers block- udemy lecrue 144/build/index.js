...
/* harmony import */ var react_color__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-color */ "./node_modules/react-color/es/index.js");
    ...
    (function () {
      let locked = false; //"wp.data.subscribe function: " Listen to the general scop of all blocks, This way we can get the event if a user make any change in any section on the screen 
    ...
    wp.blocks.registerBlockType("ybdplugin/are-you-paying-attention", {
      ...
      example: {
        // this wil allow us to display a priview when user hover our block after he click the + icon to add a new block to the editor
        attributes: {
    ...
    function EditComponent(props) {
      ...
      function deleteAnswer(indexToDelete) {
        ...
        props.setAttributes({
          answers: newAnswers
        }); // we set the answers array to our new one (see line 78...)
      ...
      return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        // we run the next code (inside "return(...)") for each answer in the array to generate answer box for our question
        return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Flex, null, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.FlexBlock, null, (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
          ...
          onChange: newValue => {
            ...
            props.setAttributes({
              answers: newAnswers
            }); // we update the answers array with the new, updated  answer array
          }
        ...
        onClick: () => {
          ...
          }); // we careate a new coppy of our array with an empty answer to be filed later by the user
        }
      }, "Add another answer"));
    }
  })();
